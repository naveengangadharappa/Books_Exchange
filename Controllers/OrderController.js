    ...
    try {
        ...
        switch (filter) {
            case "add":
                ...
                params.data = [req_data.buyer_id,req_data.book_id,req_data.book_price,req_data.seller_id,order_id]; 
                break;
            case "delete":
            ...
            case "update":
                ...
                params.data = [req_data.buyer_id,req_data.book_id,req_data.book_price,req_data.seller_id,req_data.order_id];
                break;
